  ...
  return (
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
      ...
      <div
        ...
        style={{ backgroundImage: "url('ip-hero.png')" }}
      />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center mt-10">
        <h1 className="text-white mb-7 text-5xl sm:text-6xl lg:text-7xl leading-tight">
        ...
        <p className="text-white/90 text-lg sm:text-xl lg:text-2xl mb-9 leading-relaxed mt-10">
        ...
        <div className="flex justify-center items-center mt-10 mb-16">
          <Button
            ...
            className="bg-gradient-to-r from-[#C1272D] to-[#FF4D00] hover:from-red-700 hover:to-orange-600 
                   text-white text-lg px-10 py-6 h-auto shadow-2xl hover:shadow-orange-500/50 
