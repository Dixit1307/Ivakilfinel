...
export function AgrochemicalPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Helmet>
        <title>
          Agrochemical IP Services India – Protect & Maximize Innovations
        </title>
        <meta
          name="description"
          content="iVakil IP offers expert IP services for the agrochemical industry in India, including patents, trademarks, trade secrets, and regulatory support. We help safeguard and commercialize innovations in sustainable agriculture, ensuring legal protection, market advantage, and compliance for crop protection, biotechnology, and agri-input companies. Partner with iVakil IP to secure your agrochemical intellectual property and drive business growth."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="border-2 border-green-200 bg-white">
            <CardContent className="pt-8">
              <h2 className="text-gray-900 mb-6 text-4xl font-bold">
                Trusted by Research-Driven Agrochemical Innovators
              </h2>
              <p
