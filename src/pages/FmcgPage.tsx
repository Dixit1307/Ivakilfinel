...
export function FMCGPage() {
    return (
        <div className="min-h-screen bg-white">
            {/* SEO Meta Tags */}
            <Helmet>
                <title>FMCG IP Services in India – Protect Brands & Product Innovation</title>
                <meta
                    name="description"
                    content="iVakil IP helps FMCG companies in India protect trademarks, packaging designs, trade secrets, and brand identity. Ensure legal security and market advantage for your products."
                />
            </Helmet>
