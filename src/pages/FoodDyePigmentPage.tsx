...
export function FoodDyePigmentPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Helmet>
        <title>
          Food, Dye & Pigment IP Services India – Protect Formulations
        </title>
        <meta
          name="description"
          content="iVakil IP provides expert IP services for food, dye, and pigment companies in India, including patents, FTO analysis, trademarks, and licensing to safeguard formulations, colors, and innovative processes."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={i}
                className="border-2 border-gray-100 hover:border-yellow-300 hover:shadow-xl transition-all"
              >
...
export default FoodDyePigmentPage;