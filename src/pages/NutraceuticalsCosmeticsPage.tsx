...
export function NutraceuticalsCosmeticsPage() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <Helmet>
        <title>
          Nutraceuticals & Cosmetics IP Services India – Protect Innovations
        </title>
        <meta
          name="description"
          content="iVakil IP provides expert IP services for nutraceutical and cosmetics companies in India, including patents, trademarks, design protection, and licensing to safeguard formulations, packaging, and brand innovations."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <Card
                key={i}
                className="border-2 border-gray-100 hover:border-pink-300 hover:shadow-xl transition-all"
              >
...
export default NutraceuticalsCosmeticsPage;