        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            {[
              ...
              <Card key={i} className="border-2 border-gray-100 hover:border-amber-300 hover:shadow-xl transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Card className="border-2 border-amber-300 bg-white">
            <CardContent className="pt-8">
              ...
              <h2 className="text-gray-900 mb-6 text-4xl font-bold">Serving Innovators Across Animal Health Segments</h2>
